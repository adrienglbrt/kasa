...
function ListingRating({ data }) {
    ...
    for (let i = 0; i < filledStars; i++) {
        stars.push(
            <img src={filledStar} className='listing-rating__star listing-rating__star--filled' alt='filled rating star'/>
        )
    }
    if (emptyStars !== 0) {
        for (let i = 0; i < emptyStars; i++) {
            stars.push(
                <img src={emptyStar} className='listing-rating__star listing-rating__star--empty' alt='empty rating star'/>
            )
        }
    }
